...
public class ReplicaAckMessage extends BunshinMessage {

  private Id key;
  private Object value;
  private NodeHandle source;
	
  public ReplicaAckMessage(Id key, NodeHandle source) {  	
  	this.key = key;  
  	this.source = source;
  }  
  ...
  public String toString() {
    return "ReplicaAckMessage from :"+source+" with key "+key;
  }
  
  
  /***************** Raw Serialization ***************************************/

  protected static final short TYPE = MessageType.REPLICA_ACK_MESSAGE;
...
//	deserialize constructor
	public ReplicaAckMessage(InputBuffer buf) throws IOException {	  
