...
public class PutMessage extends BunshinMessage {

  private Id key;
  private Serializable value = null;  
  private NodeHandle source;
    
  public PutMessage(Id key, Serializable value, NodeHandle source) {  	
    this.key = key;
    this.value = value;    
    this.source = source;
  }  
  ...
  public String toString() {
    return "PutMessage key "+key+" value : "+value+" from "+source;
  }
  
  /***************** Raw Serialization ***************************************/

  protected static final short TYPE = MessageType.PUT_MESSAGE;
