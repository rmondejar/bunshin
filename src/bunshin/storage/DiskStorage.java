 ...
 */
public class DiskStorage implements StorageManager {
    ...
    private void loadInfoDir() throws ClassNotFoundException {    	
	...
	private Serializable load(String context, Id key)	{
